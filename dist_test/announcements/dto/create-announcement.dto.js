...
__decorate([
    (0, class_validator_1.IsUUID)('4', { message: 'El ID de la clase debe ser un UUID válido.' }),
    (0, class_validator_1.IsNotEmpty)({ message: 'El ID de la clase es obligatorio para un anuncio.' }),
    __metadata("design:type", String)
